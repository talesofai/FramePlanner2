...
export const bubbleOptionSets = {
  "rounded": {
    link: {hint:"连接", icon:"unite"}, 
    tailTip: {hint: "尾巴的尖端", icon:"tail", init: (b) => [0,0]}, 
    tailMid: {hint: "尾巴的途中", icon:"curve", init: (b) => [0.5,0]},
    xStraight: { label: "横线长度", type: "number", min: 0, max: 0.9, step: 0.01, init: b => 0 },
    yStraight: { label: "垂直线长度", type: "number", min: 0, max: 0.9, step: 0.01, init: b => 0 },
  },
  "square": {
    link: {hint:"连接", icon:"unite"}, 
    tailTip: {hint: "尾巴的尖端",icon:"tail", init: (b) => [0,0]}, 
  ...
  "concentration": {
    lineCount: { label: "线数", type: "number", min: 100, max: 300, step: 1, init: b => 200 },
    lineLength: { label: "线条长度", type: "number", min: 1.05, max: 1.50, step: 0.01, init: b => 1.3 },
  },
  "polygon": {
    link: {hint:"连接", icon:"unite"}, 
    tailTip: {hint: "尾巴的尖端",icon:"tail", init: (b) => [0,0]}, 
    tailMid: {hint: "尾巴的途中",icon:"curve", init: (b) => [0.5,0]},
    randomSeed: { label: "随机数调整", type: "number", min: 0, max: 100, step: 1, init: b => 0 },
    superEllipse: { label: "矩形", type: "number", min: 1, max: 8, step: 0.1, init: b => 3 },
    vertexCount: { label: "顶点数", type: "number", min: 4, max: 20, step: 1, init: b => 7 },
    angleJitter: { label: "角度抖动ー", type: "number", min: 0, max: 1.0, step: 0.1, init: b => 0.4 },
  },
  "strokes": {
    randomSeed: { label: "随机数调整", type: "number", min: 0, max: 100, step: 1, init: b => 0 },
    superEllipse: { label: "矩形", type: "number", min: 1, max: 8, step: 0.1, init: b => 3 },
    vertexCount: { label: "顶点数", type: "number", min: 4, max: 20, step: 1, init: b => 10 },
    angleJitter: { label: "角度抖动ー", type: "number", min: 0, max: 1.0, step: 0.1, init: b => 0.5 },
    overRun: { label: "Oー巴氏体ー运行", type: "number", min: 1.01, max: 1.4, step: 0.01, init: b => 1.2 },
  },
  "double-strokes": {
    randomSeed: { label: "随机数调整", type: "number", min: 0, max: 100, step: 1, init: b => 0 },
    superEllipse: { label: "矩形", type: "number", min: 1, max: 8, step: 0.1, init: b => 3 },
    vertexCount: { label: "顶点数", type: "number", min: 4, max: 20, step: 1, init: b => 10 },
    angleJitter: { label: "角度抖动ー", type: "number", min: 0, max: 1.0, step: 0.1, init: b => 0.5 },
    overRun: { label: "Oー巴氏体ー运行", type: "number", min: 1.01, max: 1.4, step: 0.01, init: b => 1.25 },
    interval: { label: "间隔", type: "number", min: 0.01, max: 0.2, step: 0.01, init: b => 0.04 },
  },
  "harsh": {
    link: {hint:"连接", icon:"unite"}, 
    tailTip: {hint: "尾巴的尖端",
    ...
    randomSeed: { label: "随机数调整", type: "number", min: 0, max: 100, step: 1, init: b => 0 },
    superEllipse: { label: "矩形", type: "number", min: 1, max: 8, step: 0.1, init: b => 3 },
    bumpDepth: { label: "凹凸不平的深度", type: "number", min: 0.01, max: 0.2, step: 0.01, init: b => 0.07 },
    bumpCount: { label: "凹凸不平", type: "number", min: 4, max: 20, step: 1, init: b => 15 },
    angleJitter: { label: "角度抖动ー", type: "number", min: 0, max: 1.0, step: 0.1, init: b => 0.1 },
  },
  "shout": {
    link: {hint:"连接", icon:"unite"},
    tailTip: {hint: "尾巴的尖端",icon:"tail", init: (b) => [0,0]},
    randomSeed: { label: "随机数调整", type: "number", min: 0, max: 100, step: 1, init: b => 0, sampleInit: b => 6 },
    superEllipse: { label: "矩形", type: "number", min: 1, max: 8, step: 0.1, init: b => 3, sampleInit: b => 3 },
    bumpSharp: { label: "突出的锐度", type: "number", min: 0.01, max: 0.5, step: 0.01, init: b => 0.3, sampleInit: b => 0.2 },
    bumpCount: { label: "拉伸数", type: "number", min: 4, max: 20, step: 1, init: b => 10 },
    angleJitter: { label: "角度抖动ー", type: "number", min: 0, max: 1.0, step: 0.1, init: b => 0.5, sampleInit: b => 0.2 },
    depthJitter: { label: "锐度抖动ー", type: "number", min: 0, max: 1.5, step: 0.01, init: b => 0.5, sampleInit: b => 0.1  },
  },
  "soft": {
    link: {hint:"连接", icon:"unite"}, 
    tailTip: {hint: "尾巴的尖端",icon:"tail", init: (b) => [0,0]}, 
    ...
    randomSeed: { label: "随机数调整", type: "number", min: 0, max: 100, step: 1, init: b => 0 },
    superEllipse: { label: "矩形", type: "number", min: 1, max: 8, step: 0.1, init: b => 3 },
    bumpDepth: { label: "凹凸不平的深度", type: "number", min: 0.01, max: 0.2, step: 0.01, init: b => 0.15 },
    bumpCount: { label: "凹凸不平", type: "number", min: 4, max: 20, step: 1, init: b => 8 },
    angleJitter: { label: "角度抖动ー", type: "number", min: 0, max: 1.0, step: 0.1, init: b => 0.4 },
  },
  "heart" : {link: {hint:"连接", icon:"unite"} },
  "diamond": {link: {hint:"连接", icon:"unite"} },
  "motion-lines": {
    focalPoint: {hint:"内圆中心", icon:"circle", init: (b) => [0, 0] }, 
    focalRange: {hint: "内圆范围", icon:"radius", init: (b) => [0, Math.hypot(b.size[0]/2, b.size[1]/2) * 0.25] },
    randomSeed: { label: "随机数调整", type: "number", min: 0, max: 100, step: 1, init: b => 0 },
    lineCount: { label: "线数", type: "number", min: 100, max: 300, step: 1, init: b => 200 },
    lineWidth: { label: "线宽", type: "number", min: 0.01, max: 0.1, step: 0.01, init: b => 0.05 },
    angleJitter: { label: "角度抖动ー", type: "number", min: 0, max: 0.2, step: 0.01, init: b => 0.05 },
    startJitter: { label: "起点抖动ー", type: "number", min: 0, max: 1.0, step: 0.01, init: b => 0.5 },
  },
  "speed-lines": {
    tailTip: {hint: "流线尖端",icon:"tail", init: (b) => [b.size[0]*0.4,0]},
    tailMid: {hint: "流线途中",icon:"curve", init: (b) => [0.5,0]},
    randomSeed: { label: "随机数调整", type: "number", min: 0, max: 100, step: 1, init: b => 0 },
    lineCount: { label: "线数", type: "number", min: 10, max: 200, step: 1, init: b => 70 },
    lineWidth: { label: "线宽", type: "number", min: 0.01, max: 1.0, step: 0.01, init: b => 0.2 },
    laneJitter: { label: "间隔抖动ー", type: "number", min: 0, max: 0.2, step: 0.01, init: b => 0.05 },
    startJitter: { label: "起点抖动ー", type: "number", min: 0, max: 0.5, step: 0.01, init: b => 0.3 },
  },
  "ellipse-mind": {
    link: {hint:"连接", icon:"unite"}, 
    tailTip: {hint: "尾巴的尖端",icon:"tail", init: (b) => [0,0]}, 
